...
import com.aldrin.pos.data.dao.impl.RoleDAOImpl;
...
public class JDialogUserAccountAU extends javax.swing.JDialog {
    ...
    public JDialogUserAccountAU(JFrameAldrinPOS jFrameSariPOS, boolean modal) {
    ...
    public JDialogUserAccountAU(JFrameAldrinPOS jFrameSariPOS, boolean modal, UserAccount userAccount, String title) {
        super(jFrameSariPOS, modal);
        initComponents();
    ...
    public JDialogUserAccountAU(JFrameAldrinPOS jFrameSariPOS, boolean modal, String title, UserAccount userAccount) {
        super(jFrameSariPOS, modal);
        initComponents();
