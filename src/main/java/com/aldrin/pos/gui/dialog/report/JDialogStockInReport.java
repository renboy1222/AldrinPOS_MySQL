 ...
 * @author ALRIN B.C.
 */
public class JDialogStockInReport extends javax.swing.JDialog {
    ...
    public JDialogStockInReport(JFrameAldrinPOS jFrameSariPOS, boolean modal, StockInEntry se) {
    ...
    public void showReport() {
        ...
        try {
            ...
            con.getDBConn();
            String fullPath = System.getProperty("user.dir") + "/src/main/resources/reports/stockIn.jasper";
            Map<String, Object> param = new HashMap<String, Object>();

            param.put("STOCKINID", this.stockInEntry.getStockIn().getId());
