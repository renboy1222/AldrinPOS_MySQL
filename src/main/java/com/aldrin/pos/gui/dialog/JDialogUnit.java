...
import com.aldrin.pos.gui.dialog.au.JDialogUnitAU;
...
public class JDialogUnit extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogUnit(JFrameAldrinPOS jFrameSariPOS, boolean modal) {
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogUnitAU categoryAU = new JDialogUnitAU(jFrameSariPOS, true);
        categoryAU.setVisible(true);
        selectUnit();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogUnitAU categoryAU = new JDialogUnitAU(jFrameSariPOS, true, unit, "Update");
        categoryAU.setVisible(true);
        selectUnit();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogUnitAU categoryAU = new JDialogUnitAU(jFrameSariPOS, true, "Delete", unit);
        categoryAU.setVisible(true);
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "UNIT", "DESCRIPTION"}, 0);
    ...
    private void selectUnit() {
        ...
        unitList = unitDAOImpl.selectUnit();
        for (Unit c : unitList) {
            tableModel.addRow(new Object[]{c.getId(), c.getUnit(), c.getDescription()});
        }
    }
