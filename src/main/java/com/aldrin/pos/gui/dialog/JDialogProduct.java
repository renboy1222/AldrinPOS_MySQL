...
import com.aldrin.pos.gui.dialog.au.JDialogProductAU;
 ...
 * @author ALDRIN B. C.
 */
public class JDialogProduct extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogProduct(JFrameAldrinPOS jFrameSariPOS, boolean modal) {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(826, 416));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogProductAU categoryAU = new JDialogProductAU(jFrameSariPOS, true);
        categoryAU.setVisible(true);
        selectProduct();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogProductAU productAU = new JDialogProductAU(jFrameSariPOS, true, product, "Update");
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogProductAU productAU = new JDialogProductAU(jFrameSariPOS, true, "Delete", product);
        productAU.setVisible(true);
        selectProduct();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "CATEGORY ID", "PRODUCT", "BARCODE", "CATEGORY"}, 0);
    ...
    private void setTable() {
        ...
        TableColumn hide1 = jTableProduct.getColumnModel().getColumn(1);
        hide1.setMinWidth(0);
        hide1.setMaxWidth(0);
    ...
    private void selectProduct() {
        ...
        productList = productDAOImpl.selectProduct();
        tableModel.setRowCount(0);
//        "ID", "CATEGORY ID", "PRODUCT", "BARCODE", "CATEGORY"
        for (Product p : productList) {
            tableModel.addRow(new Object[]{p.getId(), p.getCategory().getId(), p.getProduct(), p.getBarcode(), p.getCategory().getCategory()});
        }
    }
        ...
        if (e.getSource() == jTableProduct) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        Long productId = Long.parseLong(jTableProduct.getValueAt(row, 0).toString());
                        Long categoryId = Long.parseLong(jTableProduct.getValueAt(row, 1).toString());
                        String product = jTableProduct.getValueAt(row, 2).toString();
                        String barcode = jTableProduct.getValueAt(row, 3).toString();
                        String category = jTableProduct.getValueAt(row, 4).toString();
