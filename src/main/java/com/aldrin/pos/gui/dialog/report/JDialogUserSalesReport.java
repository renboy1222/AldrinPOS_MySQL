 ...
 * @author ALRIN B.C.
 */
public class JDialogUserSalesReport extends javax.swing.JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 40, 30));
    ...
    public void showReport() {
        ...
        try {
            ...
            con.getDBConn();
            String fullPath = System.getProperty("user.dir") + "/src/main/resources/reports/usersSale.jasper";
...
//            param.put("USERID", userId.getId());
            param.put("START", startId.getId());
            param.put("END", endId.getId());
            param.put("SDATE", jComboBoxStart.getSelectedItem().toString());
            param.put("EDATE", jComboBoxEnd.getSelectedItem().toString());
