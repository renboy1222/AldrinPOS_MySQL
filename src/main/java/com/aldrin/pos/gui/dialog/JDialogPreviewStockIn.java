 ...
 * @author ALRIN B.C.
 */
public class JDialogPreviewStockIn extends javax.swing.JDialog {
    ...
    public JDialogPreviewStockIn(JFrameAldrinPOS jFrameSariPOS, boolean modal, StockInEntry se) {
        ...
        setTable();
        selectStockInEntry();
        setTitle("STOCK-IN ID:[" + se.getStockIn().getId() + "]");
        autoCalulateTable();
        jLabelUser.setText(se.getUser());
        jLabelTransporter.setText(se.getTransporter());
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabelUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 160, 30));
    ...
    private StockInEntryDAOImpl stockInDAOImpl = new StockInEntryDAOImpl();
    private ArrayList<StockInEntry> stockInEntryList;

    private void selectStockInEntry() {
//      "STOCK IN ID", "#", "UNIT", "PRODUCT", "QUANTITY", "BUYING PRICE", "SELLING PRICE", "LINE TOTAL"
...
//        jTableStockInEntry.addMouseListener(this);
        ...
        column[3].setPreferredWidth(250);
